        ...
        <div class="relative z-10">
          ...
          >
            <svg viewBox="0 0 128 128" class="h-36 w-36" aria-label="Logo" role="img" xmlns="http://www.w3.org/2000/svg">
              <rect x="4" y="4" width="120" height="120" rx="24" fill="url(#authLogoRegisterHero)" />
              ...
              <defs>
                <linearGradient id="authLogoRegisterHero" x1="14" y1="8" x2="114" y2="120" gradientUnits="userSpaceOnUse">
